...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar un atleta determinado");
	 ...
	 */
	public void ejecutarNombrePais()
	{
		String atleta = input("Por favor ingrese el nombre del atleta");
		Pais pais = calculadora.ejecutarNombrePais(atleta);
		if (pais != null)
		{
			System.out.println("El pais al cual representa el atleta " + atleta + " es " + pais.darNombre());
		}
		else
		{
			System.out.println("El atleta que está consultando no existe en los datos");
		}		
	}
